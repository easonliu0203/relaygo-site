...
const LOCALE_KEYWORDS: Record<Locale, string> = {
  'zh-TW': 'RelayGo, 台灣包車, 機場接送, 包車旅遊, 台灣自由行, 台灣自由行攻略, 台灣美食, 台灣小吃, 九份美食, 九份老街美食, 台北包車, 九份包車, 日月潭包車, 太魯閣包車, 墾丁包車, 阿里山包車, 桃園機場接送, 松山機場接送, 台灣自由行包車, 大眾運輸自由行, 專業司機, 即時追蹤',
  'zh-CN': 'RelayGo, 台湾包车, 机场接送, 包车旅游, 台湾自由行, 台湾自由行攻略, 台湾美食, 台湾小吃, 九份美食, 台湾自由行包车, 台北包车, 九份包车, 日月潭包车, 太鲁阁包车, 垦丁包车, 桃园机场接送, 包车价格, 专业司机, 台湾一日游包车, 大众运输自由行',
  en: 'RelayGo, Taiwan private car charter, Taiwan airport transfer, Taiwan independent travel, Taiwan food tour, Taiwan street food, Taiwan local cuisine, Taipei private driver, Taiwan car rental with driver, Jiufen food guide, Jiufen private tour, Sun Moon Lake day trip, Taroko Gorge tour, Taoyuan airport pickup, Taiwan day tour, Taiwan public transit guide, private sightseeing car Taiwan',
  ja: 'RelayGo, 台湾 チャーター車, 台湾 貸切タクシー, 台湾 自由旅行, 台湾 グルメ, 台湾 屋台, 九份 グルメ, 空港送迎 台湾, 台北 貸切車, 九份 タクシー チャーター, 日月潭 ツアー, 太魯閣 ツアー, 桃園空港 送迎, 台湾 ドライバー付き, 台湾 専用車 予約, 台湾 一人旅',
  ko: 'RelayGo, 대만 전용차량 투어, 대만 택시투어, 대만 자유여행, 대만 맛집, 대만 길거리음식, 지우펀 맛집, 대만 공항 픽업, 지우펀 택시투어, 대만 프라이빗 차량, 르웨탄 투어, 타로코 투어, 타오위안 공항 픽업, 대만 일일투어, 대만 차량 예약, 대만 대중교통',
  th: 'RelayGo, เช่ารถพร้อมคนขับ ไต้หวัน, รถเช่าส่วนตัว ไต้หวัน, เที่ยวไต้หวันด้วยตัวเอง, อาหารไต้หวัน, อาหารข้างทาง ไต้หวัน, รับส่งสนามบิน ไต้หวัน, ทัวร์ส่วนตัว ไต้หวัน, ทัวร์จิ่วเฟิ่น, ทัวร์ทะเลสาบสุริยันจันทรา, ทัวร์อุทยานทาโรโกะ, รถรับส่งสนามบินเถาหยวน, จองรถ ไต้หวัน, ขนส่งสาธารณะ ไต้หวัน',
  vi: 'RelayGo, thuê xe riêng Đài Loan, đưa đón sân bay Đài Loan, du lịch tự túc Đài Loan, ẩm thực Đài Loan, món ăn đường phố Đài Loan, thuê xe có tài xế Đài Loan, tour Cửu Phần, tour Hồ Nhật Nguyệt, tour Thái Lỗ Các, đón sân bay Đào Viên, xe riêng Đài Bắc, tour một ngày Đài Loan, phương tiện công cộng Đài Loan',
  ms: 'RelayGo, sewa kereta dengan pemandu Taiwan, pindahan lapangan terbang Taiwan, melancong sendiri Taiwan, makanan Taiwan, makanan jalanan Taiwan, kereta sewa peribadi Taiwan, lawatan Jiufen, lawatan Tasik Matahari Bulan, lawatan Taroko, pengambilan lapangan terbang Taoyuan, kereta sewa harian Taiwan, pengangkutan awam Taiwan',
  id: 'RelayGo, sewa mobil dengan sopir Taiwan, antar jemput bandara Taiwan, wisata mandiri Taiwan, kuliner Taiwan, jajanan kaki lima Taiwan, sewa mobil pribadi Taiwan, tur Jiufen, tur Danau Matahari Bulan, tur Taroko, penjemputan bandara Taoyuan, sopir pribadi Taiwan, wisata Taiwan, transportasi umum Taiwan',
  fil: 'RelayGo, Taiwan private car, Taiwan airport transfer, Taiwan independent travel, Taiwan food tour, Taiwan street food, Taiwan tour package, Jiufen tour, Sun Moon Lake tour, Taroko tour, Taoyuan airport pickup, Taiwan day tour from Philippines, Taiwan public transit guide',
};
