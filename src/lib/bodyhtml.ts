...
export function getBodyHTML(langPrefix: string = '', lang: string = 'zh-TW', pricing?: PricingTables): string {
    ...
    <div class="nav-inner">
      ...
      <div class="nav-right">
        <ul class="nav-links">
          ...
          <li class="nav-secondary"><a href="${langPrefix}/cases" data-i18n="nav_cases">實際案例</a></li>
          <li><a href="${langPrefix}/faq" data-i18n="nav_faq">常見問題</a></li>
          <li class="nav-secondary"><a href="${langPrefix}/bookmarks" data-i18n="nav_bookmarks">旅遊書籤</a></li>
    ...
    <div class="trust-inner fade-up">
      ...
      <div class="trust-body">
        ...
        <div class="trust-partner-row">
          <span class="trust-partner-prefix" data-i18n="trust_partner_prefix">合作金流商</span>
          <strong class="trust-partner-name">台灣萬事達金流股份有限公司</strong>
        </div>
        <p class="trust-desc" data-i18n="trust_desc">由台灣金管會監管、合作銀行授權的合法金流公司處理所有信用卡交易，每一筆刷卡消費皆依金融法規層層把關，您的支付資訊與消費權益受到完整保障。</p>
        <div class="trust-tags">
          <span class="trust-tag" data-i18n="trust_tag_regulated">政府監管</span>
          <span class="trust-tag" data-i18n="trust_tag_bank">銀行授權</span>
  ...
  <!-- Real Service Cases -->
  <section class="cases-section" id="cases-preview">
    <div class="section-inner">
      <div class="section-header fade-up">
        <a href="${langPrefix}/cases" class="section-label section-label-link" data-i18n="cases_label">實際案例</a>
        <h2 class="section-title" data-i18n="cases_title">真實服務紀錄</h2>
        <p class="section-desc" data-i18n="cases_desc">每一段旅程，我們都用心對待。為保護客戶隱私，照片中所有人臉皆已馬賽克處理。</p>
      </div>
      <div class="cases-grid" id="casesGrid" data-i18n-lang="${lang}">
